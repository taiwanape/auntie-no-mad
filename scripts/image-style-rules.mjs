export const IMAGE_STYLE_RULE_VERSION = "auntie-reference-v10";
...
export const AUNTIE_STYLE_RULES = [
  "SECTION REFERENCE LOCK: use only the references chosen for the content section. The character reference locks Auntie's identity. The section scene reference locks the website cover style, richer prop density, table/room staging, layered foreground-midground-background composition, and polished editorial comic rendering. Do not mix unrelated section references and do not use any single reference as a pose template.",
