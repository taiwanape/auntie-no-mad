export const IMAGE_STYLE_RULE_VERSION = "auntie-reference-v7";
...
export const AUNTIE_STYLE_RULES = [
  ...
  "NO FLAT TEMPLATE LOOK: avoid plain yellow walls with a few icons, repeated standing pose, copy-paste phone-in-hand pose, sparse warning-symbol layouts, overly flat vector shapes, generic stock illustration, and empty background space.",
