export const IMAGE_STYLE_RULE_VERSION = "auntie-reference-v11";
...
export const AUNTIE_STYLE_RULES = [
  "SECTION REFERENCE LOCK: use only the references chosen for the content section. The section scene reference is the primary visual target and locks the website cover style, richer prop density, table/room staging, layered foreground-midground-background composition, and polished editorial comic rendering. The character reference is secondary and locks Auntie's identity. Do not mix unrelated section references and do not use any single reference as a pose template.",
  ...
  "NO FLAT TEMPLATE LOOK: avoid plain yellow walls with a few icons, repeated standing pose, copy-paste phone-in-hand pose, sparse warning-symbol layouts, overused warning triangles, generic chart walls, sticker/icon wallpaper, overly flat vector shapes, generic stock illustration, and empty background space.",
